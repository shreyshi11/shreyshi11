...
- 📚 Strong in Data Structures & Algorithms, DBMS, Operating Systems, and Computer Networks
...
A smart web platform that helps students explore universities and courses based on their interests, eligibility, entrance exams, rankings, and career goals.
...
A deep learning application that classifies skin lesions using medical image datasets.
...
> I enjoy building software that solves real-world problems and continuously improving my problem-solving skills.
